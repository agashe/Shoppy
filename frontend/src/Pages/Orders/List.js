                                ...
                                [1, 2, 3, 4, 5].map((row, i) => {
                                    return (
                                        <tr key={i}>
                                            ...
                                            <td className="align-middle">A5Df78251</td>
                                            <td style={{ width: '100px' }} className="align-middle">$150.25</td>
                                            <td className="align-middle">3</td>
                                            <td style={{ width: '100px' }} className="align-middle"><StatusBadge status={'pending'} /></td>
                                            <td className="align-middle">20/11/2023 - 11:50</td>
                                            <td style={{ width: '175px' }} className="align-middle">21/11/2023 - 03:14</td>
                                            <td>
